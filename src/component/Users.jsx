  ...
  return (
    <div className="flex">
      ...
      <div className="p-4 flex-1">
        ...
        <div className="mt-6">
          ...
          {showActions && (
            <div className="bg-dark shadow rounded p-4 mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
              ...
              >
                <FaChartLine className="inline-block mr-2" /> Create Report
              </button>
            </div>
          )}
        </div>
        ...
        {/* Chart Section */}
        <div className="mt-8">
          <h2 className="text-2xl font-bold mb-4">User Levels Analysis</h2>
          <div className="bg-dark rounded-lg p-4 h-80">
